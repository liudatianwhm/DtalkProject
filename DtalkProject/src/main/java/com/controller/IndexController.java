...
public class IndexController {
	 ...
	 */
	@LocalLog(module = "登录模块",method = "测试方法")
	@RequestMapping(value = "/welcome", method = RequestMethod.GET)
	public String welcome(@RequestParam("userList") String userList) {
		System.out.println(userList);
//		String[] split = userList.split(",");
//		List<String> stringList = Arrays.asList(split);
//		studentSerive.batchInsert(stringList);

		return studentSerive.getDetails(1).getName()+httpConfig.getStatusUrl();
	}
